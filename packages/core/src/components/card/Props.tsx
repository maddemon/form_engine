    ...
    <>
      <FieldItem label={locale.component.card.title}>
        <w.Input
          ...
          placeholder={locale.component.card.titlePlaceholder}
        />
      </FieldItem>
      ...
      <FieldItem label={locale.component.card.bodyPadding}>
        <w.NumberInput
          value={(values.bodyPadding as number) ?? 16}
          onChange={(v) => onChange('bodyPadding', v)}
          min={0}
          max={200}
        />
      </FieldItem>
      <FieldItem label={locale.component.card.bodyGap}>
        <w.NumberInput
          value={(values.bodyGap as number) ?? 8}
          onChange={(v) => onChange('bodyGap', v)}
          min={0}
          max={100}
        />
      </FieldItem>
